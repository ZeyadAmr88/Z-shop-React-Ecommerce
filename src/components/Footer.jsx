...
const title = "About Z-Shop";
const desc =
  "Our sport shop offers a wide selection of high-quality gear and apparel for athletes of all levels.";
    ...
    <footer className="style-2">
      <div className="footer-top dark-view padding-tb">
        <div className="container">
          <div className="row g-4 row-cols-xl-3 row-cols-sm-2 row-cols-1 jusctify-content-center">
            <div className="col">
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="section-wrapper">
            <p>
              &copy; 2024 <Link to="/">Z-Shop</Link> Designed by{" "}
